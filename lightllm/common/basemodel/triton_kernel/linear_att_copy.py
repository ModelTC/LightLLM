...
def _copy_linear_att_state_to_kv_buffer(
    ...
    cur_layer = tl.program_id(0)
    cur_batch_size = tl.program_id(1)
    ...
    cur_req_idx = tl.load(b_req_idx + cur_batch_size) * (mtp_step + 1)
    req_to_mem_start = (
