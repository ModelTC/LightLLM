...
from lightllm.utils.envs_utils import select_diverse_max_batch_shared_group_size
...
def gqa_token_decode_attention_flash_decoding_diverse(
    ...
    max_batch_group_size = (
        select_diverse_max_batch_shared_group_size(batch_size)
        if max_batch_group_size is None
        else max_batch_group_size
    )
