...
class GlmMlaTritonAttBackend(BaseAttBackend):
    def create_att_prefill_state(self, infer_state) -> "GlmMlaTritonPrefillAttState":
        return GlmMlaTritonPrefillAttState(backend=self, infer_state=infer_state)

    def create_att_decode_state(self, infer_state) -> "GlmMlaTritonDecodeAttState":
        return GlmMlaTritonDecodeAttState(backend=self, infer_state=infer_state)


@dataclasses.dataclass
class GlmMlaTritonPrefillAttState(BasePrefillAttState):
    def init_state(self):
        pass
...
@dataclasses.dataclass
class GlmMlaTritonDecodeAttState(BaseDecodeAttState):
    def init_state(self):
        pass

    def copy_for_decode_cuda_graph(self, new_state: "GlmMlaTritonDecodeAttState"):
