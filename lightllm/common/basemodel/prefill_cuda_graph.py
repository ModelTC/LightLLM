...
class PrefillCudaGraph:
    ...
    def warmup(self, model):
        logger.info("Begin capture prefill cudagraph, use --disable_prefill_cudagraph to disable it.")
        # for typing easy
    ...
    def warmup_overlap(self, model):
        logger.info("Begin capture prefill overlap cudagraph, use --disable_prefill_cudagraph to disable it.")
        # for typing easy
        from .basemodel import TpPartBaseModel
