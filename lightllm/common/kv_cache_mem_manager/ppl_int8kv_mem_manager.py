...
from .kv_buffer.quant_kv_buffer import PPLInt8QuantKvBuffer
...
class PPLINT8KVMemoryManager(MemoryManager):
    ...
    def _init_buffers(self, size, dtype, head_num, head_dim, layer_num):
        self.kv_buffer = PPLInt8QuantKvBuffer(
            torch.empty((layer_num, size + 1, 2 * head_num, head_dim), dtype=torch.int8, device="cuda"),
