...
from lightllm.third_party.sglang_jit.jit_utils import (
    cache_once,
    is_arch_support_pdl,
    load_jit,
    make_cpp_args,
)
from lightllm.third_party.sglang_jit.runtime_utils import is_hip
...
def fused_k_norm_rope_flashmla(
    ...
    head_dim = kv.shape[-1]
    rope_dim = freqs_real.shape[-1]
    module = _jit_main_k_norm_rope_flashmla_module(kv.dtype, head_dim, rope_dim, page_size)
