    ...
    def scatter_next_tokens(
        ...
        *,
        ...
        mtp_scatter_next_token_ids(
            ...
            # A profitable full-width Eagle3 plan deliberately uses Static's
            # argmax-only proposer and therefore has no confidence matrix to
            # scatter.  Leave the probability buffer untouched in that mode;
            # the next observe/confidence plan refreshes it before compaction.
