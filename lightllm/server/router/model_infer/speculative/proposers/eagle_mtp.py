...
class RecurrentEagleMTPProposer(VanillaMTPProposer):
    ...
    def make_full_verify_decode_input(
        ...
        *,
        ...
        # The target may be using the fixed-layout full fast path.  Draft
        # forwards have their own graph/layout policy and must not inherit
        # that target-only flag through the shallow ModelInput copy.
        new_input.use_static_mtp_layout = False
        return new_input
