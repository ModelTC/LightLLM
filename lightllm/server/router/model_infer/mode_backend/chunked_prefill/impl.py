...
from lightllm.server.router.model_infer.mode_backend.mtp_pre_process import (
    ...
    prepare_eagle_draft_decode_inputs,
)
...
class ChunkedPrefillBackend(ModeBackend):
    ...
    #     decode_reqs: List[InferReq],
    # ):
    #     draft_model_input, _ = prepare_eagle_draft_decode_inputs(decode_reqs)
    #     with torch.cuda.stream(g_infer_context.get_overlap_stream()):
    #         draft_model_input = prepare_eagle_draft_decode_inputs(draft_model_output)
