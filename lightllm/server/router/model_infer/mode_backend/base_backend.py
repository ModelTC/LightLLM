...
from lightllm.utils.config_utils import get_model_config_dict
...
class ModeBackend:
    ...
    def init_model(self, kvargs):
        ...
        model_cfg = get_model_config_dict(config_path=self.args.config_path, model_dir=self.weight_dir)
