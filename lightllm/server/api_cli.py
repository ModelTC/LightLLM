...
def add_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  fp8w8a8-b128                   FP8; W block 128x128, A group 128      CUTLASS\n"
            "  fp8w8a8-b128-cutlass           FP8; W block 128x128, A group 128      CUTLASS\n"
            "  fp8w8a8-b128-deepgemm          FP8; W block 128x128, A group 128      DeepGEMM\n"
            "  awq                            INT4 weight-only; checkpoint group     AWQ CUDA Kernel / PyTorch\n"
