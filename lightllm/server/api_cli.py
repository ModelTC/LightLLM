...
def add_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  fp8w8a8-pt-cutlass             FP8; W per-tensor, A per-token         vLLM\n"
            "  fp8w8a8-pt-sgl                 FP8; W per-tensor, A per-token         SGL\n"
            "  fp8w8a8-b128                   FP8; W block 128x128, A group 128      vLLM\n"
            "  fp8w8a8-b128-cutlass           FP8; W block 128x128, A group 128      vLLM\n"
