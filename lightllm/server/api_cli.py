...
def add_cli_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  quant_type                     quantization                           runtime operator path\n"
            "  w8a8                           INT8; W per-channel, A per-token       vLLM quant -> CUTLASS\n"
            "  fp8w8a8                        FP8; W per-channel, A per-token        vLLM quant -> "
            "CUTLASS(default)/Triton(env)\n"
            ...
            "  fp8w8a8-b128                   FP8; W block 128x128, A group 128      SGL/Triton quant -> "
            "CUTLASS(N%%128=0)/Triton\n"
            ...
            "  none                           No quantization                        model-dependent\n"
            "  fp8w8a8-pt                     FP8; W per-tensor*, A per-token        Triton quant -> Triton\n"
