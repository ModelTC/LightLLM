...
def normal_or_p_d_start(args):
    ...
    if args.enable_multimodal_x2i:
        from .x2i_server.manager import get_enable_cfg, X2VConfig
        X2VConfig.get(args)
        args.x2i_enable_cfg = get_enable_cfg()
    ...
    if args.enable_multimodal_x2i:
        from .x2i_server.manager import get_visible_device_env_name, start_x2i_process, setup_devices
        ...
        process_manager.start_submodule_processes(
            ...
            start_envs=[
                {get_visible_device_env_name(args): setup_devices(args)},
            ],
        )
