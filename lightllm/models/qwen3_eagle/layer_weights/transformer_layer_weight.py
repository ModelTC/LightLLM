...
class Qwen3EagleTransformerLayerWeight(LlamaTransformerLayerWeight):
    ...
    def _init_norm(self):
        ...
        self.qk_norm_weight_ = None
        architecture = (self.network_config_.get("architectures") or [""])[0]
        if architecture in {"Eagle3Speculator", "Qwen3Eagle3Model"}:
