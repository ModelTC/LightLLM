...
from lightllm.models.qwen3next.layer_weights.shared_expert_mixin import SharedExpertWeightMixin
from typing_extensions import override


class Qwen3NextFullAttentionTransformerLayerWeight(SharedExpertWeightMixin, Qwen3MOETransformerLayerWeight):
...
class Qwen3NextGatedDeltaNetTransformerLayerWeight(SharedExpertWeightMixin, Qwen3MOETransformerLayerWeight):
    def __init__(self, layer_num, data_type, network_config, quant_cfg=None):
        self.is_moe = (
