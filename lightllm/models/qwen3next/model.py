...
class Qwen3NextTpPartModel(Qwen3MOEModel):
    ...
    def _init_mem_manager(self):
        ...
        if linear_attn_cache_size is not None:
            assert linear_attn_cache_size >= start_args.running_max_req_size, "linear_attn_cache_size must be greater than running_max_req_size"
        ...
        conv_dim = self.head_linear_k_dim * self.num_linear_k_heads * 2 + self.head_linear_v_dim * self.num_linear_v_heads
