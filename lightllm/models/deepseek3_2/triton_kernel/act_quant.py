# Adapted from:
# https://github.com/sgl-project/sglang/blob/ce6b17c0f94e6bf53633c8f324176a891e67fa7f/python/sglang/srt/layers/attention/nsa/triton_kernel.py
...
def act_quant(
    ...
    Args:
        x (torch.Tensor): The input tensor to be quantized. Must be contiguous
            and its last dimension size must be divisible by `block_size`.
