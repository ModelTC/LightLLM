...
from lightllm.models.deepseek3_2.infer_struct import Deepseek3_2FlashInferStateInfo
...
class Deepseek3_2TpPartModel(Deepseek2TpPartModel):
    ...
    # infer state class
    infer_state_class = Deepseek3_2FlashInferStateInfo
    ...
    def _init_mem_manager(self):
        ...
        self.mem_manager = Deepseek3_2MemoryManager(
