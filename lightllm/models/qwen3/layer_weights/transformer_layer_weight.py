...
class Qwen3TransformerLayerWeight(Qwen2TransformerLayerWeight):
    ...
    def _init_norm(self):
        ...
        self.q_norm_weight_ = NormWeight(self.head_dim, weight_name=self._q_norm_name, data_type=self.data_type_)
        self.k_norm_weight_ = NormWeight(self.head_dim, weight_name=self._k_norm_name, data_type=self.data_type_)
