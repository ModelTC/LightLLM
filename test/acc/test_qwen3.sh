...
LOADWORKER=18 CUDA_VISIBLE_DEVICES=6,7 python -m lightllm.server.api_server --model_dir /mtc/models/qwen3-8b --tp 2 --dp 2 --port 8089 --max_total_token_num 200000 --enable_cpu_cache  --cpu_cache_storage_size 128 --cpu_cache_token_page_size 4 --enable_disk_cache --disk_cache_storage_size 128 --disk_cache_dir /mtc/test/tmp/
