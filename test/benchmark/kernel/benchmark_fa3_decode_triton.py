...
def run_fa3_mla_mtp(
    ...
    cu_seqlens_q = torch.arange(0, batch_mtp * s_q + 1, step=s_q, dtype=torch.int32, device=q.device)
    ...
    def flash_mla_fa3():
        ...
        return o.view([batch_mtp, s_q, h_q, dv])
...
if __name__ == "__main__":
    ...
    q = torch.randn(batch_mtp, mtp_size, h_q, d, dtype=dtype, device=device)
    ...
    o = torch.empty((b, h_q, dv), dtype=dtype, device="cuda")
